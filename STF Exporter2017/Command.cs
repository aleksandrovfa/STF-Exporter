...
namespace STFExporter
{
    ...
    public class Command : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            _doc = doc;
            _ARdoc = doc;
            //var link = new FilteredElementCollector(_doc).OfClass(typeof(RevitLinkInstance)).Where(r => r.Name.Contains("АР") || r.Name.Contains("AR")).FirstOrDefault() as RevitLinkInstance;
